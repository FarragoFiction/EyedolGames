...
const initPhilosophy = () => {
    ...
    philosophy[TWISTING] = ["Dementophobia is a type of phobia that involves the fear of madness or insanity. People who have this fear are afraid that they are going insane or losing touch with reality. The fear may be triggered by a family history of mental illness or periods of severe stress.", "Who's on first?", "Let's eat grandmother.", "That that is is that that is not is not is that it it is.", "James while John had had had had had had had had had had had a better effect on the teacher.", "The complex houses married and single soldiers and their families.", "The old man the boat.", "Buffalo buffalo Buffalo buffalo buffalo buffalo Buffalo buffalo. But why do Buffalo buffalo Buffalo buffalo buffalo buffalo Buffalo buffalo? ", "The horse raced past the barn fell.", "When is a door not a door? When it is a jar. When is a jar not a jar? When it's a door. When is a door not a door? When it's a jar. When is a jar not a jar? When it's a train. When is a train not a train? When it is a choo-choo. When is a choo-choo not a choo-choo? When Blain the Train is insane."];
