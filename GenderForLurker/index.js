...
const randomQuestion = () => {
  let html;
  question_index++;
  let generators = [randomRadioGenderAffirm]
...
const randomRadioGenderAffirm = () => {
  ...
  for (let i = 0; i < amount; i++) {
    ...
    ${pickFrom(["Obsession Is A Dangerous Thing", "It Hurts", "Stop Scrolling", "Go Away", "Please Stop", "Zampanio", "Zampanio", "Zampanio", "Zampanio", "Zampano", "Goncharov", "Pamzino", "Zampanio", "Zampanini", "Zampiano"]    )}   </div>`;
    } else {

      ill_advised_raw_html += `<div class='horizontal-radio'><input id="${id}" name="radio-${question_index}" type="radio"></input><label for="${id}"  class='gender'>
    ${pickFrom(["<a target='_blank' href='http://www.knucklessux.com/Blog/'>An Ancient Seeming Blog</a>", "<a target='_blank' href='http://knucklessux.com/InfoTokenReader/'>InfoTokens</a>", "<a target='_blank' href='http://farragofiction.com/RabbitSim/'>RabbitSim</a>", "<a target='_blank' href='http://farragofiction.com/ZampanioSim/'>Zampanio</a>", "<a target='_blank' href='http://eyedolgames.com/Eyedlr/?seed=4300216'>Eyedlr</a>", "<a target='_blank' href='http://eyedolgames.com/Zampanini/'>Zampanini</a>",
        "<a target='_blank' href='http://eyedolgames.com/JackElope/'>JackElope</a>",
        miracle, effects, effects, effects, miracle, monster_desc, effects, miracle, effects, effects, effects, miracle, monster_desc, effects, miracle, effects, effects, effects, miracle, monster_desc, effects, miracle, effects, effects, effects, miracle, monster_desc, effects, miracle, effects, effects, effects, miracle, monster_desc, effects, miracle, effects, effects, effects, miracle, monster_desc, effects, miracle, effects, effects, effects, miracle, monster_desc, effects, miracle, effects, effects, effects, miracle, monster_desc, effects, miracle, effects, effects, effects, miracle, monster_desc, effects, miracle, effects, effects, effects, miracle, monster_desc, effects])}</label>
    </div>`;
    }
  }
  ill_advised_raw_html += '</div></div>'
