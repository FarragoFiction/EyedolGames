...
const generateAQuestion = () => {
        const options = REALLYRandomGenders();
        const templates = [`${pickFrom(options)} is as Zampanio as: `,`Zampanio isn't just a game, it's also: `,`Unlike Pong, Zampanio is:`,`Which best represents Zampanio?`,`Zampanio is...`,`When you think about Zampanio, you most think about: `,`Zampanio isn't really ${pickFrom(options)}, its more:`,`${pickFrom(options)} is to ${pickFrom(options)} as Zampanio is to: `]
