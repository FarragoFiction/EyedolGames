...
//https://jadedresearcher.tumblr.com/post/175107968749/i-have-driven-back-the-forces-of-the-deacon-of i really need to let him invade zampanio. he'd feel right at home

//since the typist caused me to post it, i'll stop trolling future me QUITE so much  (i always go to NoteBookSim first and then panic debug it to figure out why the secret doens't work)
const notebook1 = 'http://farragofiction.com/NotebookSimulator/'
//while also letting there be a hitn that they are DIFFERNET (click yongkis face in the 'real' one)
const notebook2 = 'http://farragofiction.com/NoteBookSim/'

//true random
const realIs1 = Math.random() > 0.5;

const realNotebook = realIs1 ? notebook1 : notebook2;
const fakeNotebook = realIs1 ? notebook2 : notebook1;


const links = ["What can you <a target='_blank' href='http://eyedolgames.com/'>find</a>?", "Which <a target='_blank' href ='http://farragofiction.com/ZampanioSim/'>direction</a> will you go?", "Wow I want to go <a target='_blank' href='http://farragofiction.com/MallSim/'>shopping</a> forever!", "omg these <a target='_blank' href ='http://eyedolgames.com/QuotidianAdoption/'>pets</a> are so cute!!!", `Go <a target="_blank" href = 'http://eyedolgames.com/ZWorld?seed=${new Date().getHours()}'>here</a> for a good time!`, `JR, JR, JR, please don't forget <a title="or is it? don't trust dumb crows" target='_blank' href = '${realNotebook}'>this notebook</a> is the right one! Dont' look at <a title="maybe this one is the true one? how would you tell? are they even different?" target='_blank' href = '${fakeNotebook}'>that notebook</a>`, "Who made <a target='_blank' href = 'https://scratch.mit.edu/projects/666438974/'>this</a>?",
  "Who made <a target='_blank' href = 'https://www.tumblr.com/epic-semicolon-ftw/721052082903416832/now-for-the-general-public-zombpanio-hwe?source=share'>this</a>?", "Who made <a target='_blank' href = 'https://hydrozoa-games.itch.io/zam2anio'>this</a>?", "You might need <a target='_blank' href ='https://archiveofourown.org/works/41083818'>this</a> if you're going to start hunting around for secrets.", "<a target='_blank' href ='http://farragofiction.com/FruitSim/'>Fruit</a> is delicious! But can you find any in the <a target='_blank' href = 'http://www.farragofiction.com/ZampanioSimEast'>East?</a>", `Man, did you hear the <a target='_blank' href='http://eyedolgames.com/News/?referer=Eyedlr&name=Tumblr'>news</a>?`, "where is <a target='_blank' href ='https://jadedresearcher.tumblr.com/post/175107968749/i-have-driven-back-the-forces-of-the-deacon-of'>he</a>/", "bet you can't handle <a target='_blank' href ='http://farragofiction.com/AnxietySim/'>this</a> ;)", "oh wow what do you think this <a target='_blank' href ='http://gigglesnort.info/magicant/'>warning</a> means?", "whoa hey is <a target='_blank' href = 'http://farragofiction.com/ZampanioSimLegal'>this</a> real?", "wanna watch a <a target='blank' href ='http://farragofiction.com/RabbitSim/'>stream</a> with me :)", "lol no one can beat this <a target='_blank' href = 'http://farragofiction.com/MurderOnTheScorpiusExpressSim/'>game</a>", "does  <a target='blank' href='https://drive.google.com/drive/folders/1LCxnK5HMkSXscfXtzzv46ysaPRpa4p4u?'>this</a> make any sense to you???", "don't get lost   <a target='blank' href ='http://knucklessux.com/PuzzleBox/Secrets/Gopher%20Hole%20CYOA_by_Guide_of_Hunters.pdf'>here</a> ;) ;) ;)", "omg i'm literally addicted to playing this <a target='_blank' href='http://knucklessux.com/PuzzleBox/Secrets/Watcher/shambling_yes_no_presentation_by_the_watcher_of_threads.ppsx'>game</a>.", "Oh, have you seen <a target='_blank' href='http://www.farragofiction.com/TheTruthAboutAlt/'>this?</a>", "<a target='_blank' href ='http://farragofiction.com/?filter=zampanio'>Zampanio</a> awaits", "oh my god you'll never believe what you'll find  <a target='_blank' href ='https://discord.gg/tZmtKwnbac'>here</a>", "I know this good site for ordering food: <a target='_blank' href ='http://eyedolgames.com/Zampanini/'>click here</a>", "wanna see my <a target='_blank' href = 'http://farragofiction.com/SecurityLog/cctv.html'>cam show</a> ;) ;) ;)"];

//so we can grab things like names and locations
let initChatMap = (name, loc) => {
  links.push(`omg did you see this <a target='_blank' href ='http://eyedolgames.com/News/?referer=eyedlr&name=${currentPage.name}&loc=${currentPage.loc}'>article</a>? it's so shocking!`);
  ...
  chatMap = {
    "hi": [...links, `hey I'm ${name}, I found your number when I checked my cell phone address book. Do we know each other?`, "omg great to hear from you!", "lol, we met the other day and i totally forgot to message you until now", "Hey there sexy, wanna see my <a target='_blank' href = 'http://farragofiction.com/SecurityLog/cctv.html'>cam show</a> ;) ;) ;)"],
    "yes": ["Oh.", "Why?"],
    ...
    "hello": [...links, `hey I'm ${name}, I found your number when I checked my cell phone address book. Do we know each other?`, "who are you?", "lol, we met the other day and i totally forgot to message you until now", "Hey there sexy, wanna see my <a target='_blank' href = 'http://farragofiction.com/SecurityLog/cctv.html'>cam show</a> ;) ;) ;)"],
    "hey": [...links, `hey I'm ${name}, I found your number when I checked my cell phone address book. Do we know each other?`, "why are you talking to me?", "lol, we met the other day and i totally forgot to message you until now", "Hey there sexy, wanna see my <a target='_blank' href = 'http://farragofiction.com/SecurityLog/cctv.html'>cam show</a> ;) ;) ;)"],
    "greeting": [...links, "I was looking for someone to chat with, I hope you don't mind! What are you doing?", `hey I'm ${name}, I found your number when I checked my cell phone address book. Do we know each other?`, "whoa, how did you find me?", "lol, we met the other day and i totally forgot to message you until now", "Hey there sexy, wanna see my <a target='_blank' href = 'http://farragofiction.com/SecurityLog/cctv.html'>cam show</a> ;) ;) ;)"],
    ...
    "news": [`omg did you see this <a target='_blank' href ='http://eyedolgames.com/News/?referer=JackElope&name=${name}&loc=${loc}'>article</a>? it's so shocking!`],
