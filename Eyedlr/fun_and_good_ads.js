...
//gotta have my own internal one cuz im loading weird (like im a stand alone injected script)
//look i was exhausted from kittens so i did a bit o fspahetti coding
const isItFridayAds = ()=>{
...
initSimpleAd = async () => {
  ...
  if (isItFridayAds()) {
    ...
    postContent.innerHTML = "Zampanio Will Still Be Here Later. Friday and the Midnight Hour are our reminders that Zampanio needs us to live a long, fullfilling, varied life."
