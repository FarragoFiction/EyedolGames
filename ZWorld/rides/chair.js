...
class TeaserSwing extends TeaserRide {
  rideType = CHAIR;
  ...
  constructor(rand) {
    ...
    const excitingWords = ["Tornado","Demon", "Titan", "One", "Scream", "Revenge", "Scream Machine", "Scorcher", "Dive", "Fury", "Blitz", "Ride", "Scream", "Flight", "Cyclone", "Swing"]
    ...
    super(chosenName, rand.pickFrom(chairImages), themes, obsession, nearbyAttractions, desc)
  }
}

class DetailsSwing extends DetailsRide {
  rideType = CHAIR;
