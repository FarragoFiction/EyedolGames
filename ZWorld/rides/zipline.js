const ZIPLINE = "Zipline"
//https://miggylol.tumblr.com/post/628224146297487360/what-is-the-child-annihilating-zipline
class TeaserZip extends TeaserRide {
  rideType = ZIPLINE;
  ...
  constructor(rand) {
    ...
    const excitingWords = ["RIPLine","Machine to Kill Children","Tornado","Demon", "Titan", "One", "Scream", "Revenge", "Scorcher", "Dive", "Fury", "Blitz", "Scream", "Flight", "Swing","Line"]
    ...
    `Children aged four to one hundred and four will be enchanted as this state of the art swings showcases ${rand.pickFrom(["space", "sanity", "death", "dad"])} defying spins!`,
    ...
    super(chosenName, rand.pickFrom(zipLineImages), themes, obsession, nearbyAttractions, desc)
  }
}

class DetailsZip extends DetailsRide {
  rideType = ZIPLINE;
