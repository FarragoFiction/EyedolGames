...
let chatMap = {
  "hi": ["omg great to hear from you!","lol, we met the other day and i totally forgot to message you until now","Hey there sexy, wanna see my <a target='_blank' href = 'http://farragofiction.com/SecurityLog/cctv.html'>cam show</a> ;) ;) ;)"],
  "yes":["Oh.","Why?"],
  "no":["Why not?","Are you just a hater?"],
  "hello": ["who are you?","lol, we met the other day and i totally forgot to message you until now","Hey there sexy, wanna see my <a target='_blank' href = 'http://farragofiction.com/SecurityLog/cctv.html'>cam show</a> ;) ;) ;)"],
  "hey": ["why are you talking to me?","lol, we met the other day and i totally forgot to message you until now","Hey there sexy, wanna see my <a target='_blank' href = 'http://farragofiction.com/SecurityLog/cctv.html'>cam show</a> ;) ;) ;)"],
  "greeting": ["whoa, how did you find me?","lol, we met the other day and i totally forgot to message you until now","Hey there sexy, wanna see my <a target='_blank' href = 'http://farragofiction.com/SecurityLog/cctv.html'>cam show</a> ;) ;) ;)"],
  ...
  "news":["omg did you see this <a target='_blank' href ='http://eyedolgames.com/News/?referer=JackElope'>article</a>? it's so shocking!"],
