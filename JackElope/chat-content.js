...
let initChatMap = () => {
  chatMap = {
    "hi": [`hey I'm ${currentPage.name}, I found your number when I checked my cell phone address book. Do we know each other?`,"omg great to hear from you!", "lol, we met the other day and i totally forgot to message you until now", "Hey there sexy, wanna see my <a target='_blank' href = 'http://farragofiction.com/SecurityLog/cctv.html'>cam show</a> ;) ;) ;)"],
    "yes": ["Oh.", "Why?"],
    "no": ["Why not?", "Are you just a hater?"],
    "hello": [`hey I'm ${currentPage.name}, I found your number when I checked my cell phone address book. Do we know each other?`,"who are you?", "lol, we met the other day and i totally forgot to message you until now", "Hey there sexy, wanna see my <a target='_blank' href = 'http://farragofiction.com/SecurityLog/cctv.html'>cam show</a> ;) ;) ;)"],
    "hey": [`hey I'm ${currentPage.name}, I found your number when I checked my cell phone address book. Do we know each other?`,"why are you talking to me?", "lol, we met the other day and i totally forgot to message you until now", "Hey there sexy, wanna see my <a target='_blank' href = 'http://farragofiction.com/SecurityLog/cctv.html'>cam show</a> ;) ;) ;)"],
    "greeting": [`hey I'm ${currentPage.name}, I found your number when I checked my cell phone address book. Do we know each other?`,"whoa, how did you find me?", "lol, we met the other day and i totally forgot to message you until now", "Hey there sexy, wanna see my <a target='_blank' href = 'http://farragofiction.com/SecurityLog/cctv.html'>cam show</a> ;) ;) ;)"],
    ...
    "are you there": ["lol, yeah sorry got distracted", "who were you again", "whoops, totally lost this tab", "omg i didn't mean to ghost you", "yeah whats up?"]
  }
}