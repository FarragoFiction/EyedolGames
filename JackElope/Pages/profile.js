...
class ProfilePage extends PageObject {
  ...
  setupDetails = (parent) => {
    ...
    createDetail("Job",this.rand.pickFrom(["Spy","Porn Bot","Software Developer","Nurse","Truck Driver","Manager","ffice Drone","Black Smith","Carpenter","Mechanic","Handy Man","Electrician","Plumber","Fire Fighter","Clown","Military","Police Officer","Marketing","Sales","Customer Service","Tech Support","Secretary","Bartender","Assistant","Accountant","Wait Staff","Construction Worker","Model","Doctor","Lawyer","Janitor","No","Yes","Food Prep","Cashier","Military","Programming","Retail"]));
